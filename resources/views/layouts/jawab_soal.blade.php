...
<head>
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="{{asset('admin/images/3632.jpg')}}" />
  <!--bootstrap-->
   <!-- Bootstrap CSS -->
    ...
    <div class="container-scroller">
      ...
      <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo ml-2" ><img src="" class="mr-2" alt="logo"/><label style="font-size: 16pt">Simulasi CAT</label></a>
