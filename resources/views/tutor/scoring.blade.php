        ...
        <div class="col-md-12 grid-margin">
            <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                    <h3 class="font-weight-bold">Scoring</h3>
                    <h6 class="font-weight-normal mb-0">Choose the student</h6>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @csrf
                                <td class="text-center"><a href="{{route('scoring.detail',[$level,$item->id])}}" class="btn btn-outline-primary btn-icon-text btn-sm">Score</a>
                                    @method('delete')
                                    @csrf
